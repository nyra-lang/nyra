...
impl Codegen {
    ...
    pub(super) fn emit_runtime_decls(&self, out: &mut Vec<String>) {
        let decls = [
            ...
            ("str_compare", "declare i32 @str_compare(ptr, ptr)"),
            ("str_equal_fold", "declare i32 @str_equal_fold(ptr, ptr)"),
            ("str_index_byte", "declare i32 @str_index_byte(ptr, i32)"),
            ("str_last_index_byte", "declare i32 @str_last_index_byte(ptr, i32)"),
            ("str_after_sep", "declare ptr @str_after_sep(ptr, ptr)"),
            ("str_pop", "declare ptr @str_pop(ptr)"),
            ("str_push_char", "declare ptr @str_push_char(ptr, i32)"),
            ("str_strip_ansi", "declare ptr @str_strip_ansi(ptr)"),
            ("str_collapse_ws", "declare ptr @str_collapse_ws(ptr)"),
            ("str_is_ascii", "declare i32 @str_is_ascii(ptr)"),
            ("str_common_prefix_len", "declare i32 @str_common_prefix_len(ptr, ptr)"),
            ("str_is_alnum", "declare i32 @str_is_alnum(ptr)"),
            ("str_is_alpha", "declare i32 @str_is_alpha(ptr)"),
            ("str_is_digit", "declare i32 @str_is_digit(ptr)"),
            ("str_pad_center", "declare ptr @str_pad_center(ptr, i32, ptr)"),
            ("str_reverse", "declare ptr @str_reverse(ptr)"),
            ("str_escape_json", "declare ptr @str_escape_json(ptr)"),
            ("str_split_after", "declare ptr @str_split_after(ptr, ptr)"),
            ("str_truncate", "declare ptr @str_truncate(ptr, i32)"),
        ];
