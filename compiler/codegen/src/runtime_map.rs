...
pub fn symbol_module_map() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("str_compare", "rt_strings.c"),
        ("str_equal_fold", "rt_strings.c"),
        ("str_index_byte", "rt_strings.c"),
        ("str_last_index_byte", "rt_strings.c"),
        ("ceil_i32", "rt_math.c"),
        ("floor_i32", "rt_math.c"),
        ("is_finite_f64", "rt_math.c"),
        ("is_nan_f64", "rt_math.c"),
        ("round_i32", "rt_math.c"),
        ("signum_f64", "rt_math.c"),
        ("vec_str_clear", "rt_vec.c"),
        ("vec_str_pop", "rt_vec.c"),
        ("vec_str_reverse", "rt_vec.c"),
        ("f64_to_string_prec", "rt_strings.c"),
        ("parse_int_base", "rt_strings.c"),
        ("str_to_i64", "rt_strings.c"),
        ("format_i32_pad", "rt_strings.c"),
        ("str_after_sep", "rt_strings.c"),
        ...
        ("vec_str_insert", "rt_vec.c"),
        ("vec_str_remove_at", "rt_vec.c"),
        ("vec_str_set", "rt_vec.c"),
        ("vec_str_swap", "rt_vec.c"),
        ("format_i32_hex", "rt_strings.c"),
        ("parse_uint_base", "rt_strings.c"),
        ("str_to_u64", "rt_strings.c"),
        ("format_bool", "rt_strings.c"),
        ("format_f64_pad", "rt_strings.c"),
        ("format_i32_hex_pad", "rt_strings.c"),
        ("format_i64_pad", "rt_strings.c"),
        ("str_collapse_ws", "rt_strings.c"),
        ("str_is_ascii", "rt_strings.c"),
        ("deg_to_rad_f64", "rt_math.c"),
        ("fract_f64", "rt_math.c"),
        ("gcd_i32", "rt_math.c"),
        ("lcm_i32", "rt_math.c"),
        ("mod_i32", "rt_math.c"),
        ("rad_to_deg_f64", "rt_math.c"),
        ("vec_i32_extend", "rt_vec.c"),
        ("vec_i32_swap", "rt_vec.c"),
        ("map_i32_i32_clear", "rt_map.c"),
        ("map_i32_i32_len", "rt_map.c"),
        ("map_i32_i32_remove", "rt_map.c"),
        ("hex_encode", "rt_strings.c"),
        ("hex_encode_upper", "rt_strings.c"),
        ("i32_to_string_radix", "rt_strings.c"),
        ("parse_i64_base", "rt_strings.c"),
        ("str_to_f32", "rt_strings.c"),
        ("u64_to_string", "rt_strings.c"),
        ("format_i32_bin", "rt_strings.c"),
        ("format_i32_oct", "rt_strings.c"),
        ("format_i64_hex", "rt_strings.c"),
        ("format_u64_pad", "rt_strings.c"),
        ("atomic_sub_i32", "rt_sync.c"),
        ("str_common_prefix_len", "rt_strings.c"),
        ("str_is_alnum", "rt_strings.c"),
        ("str_is_alpha", "rt_strings.c"),
        ("str_is_digit", "rt_strings.c"),
        ("str_pad_center", "rt_strings.c"),
        ("str_reverse", "rt_strings.c"),
        ("count_ones_i32", "rt_math.c"),
        ("is_infinite_f64", "rt_math.c"),
        ("leading_zeros_i32", "rt_math.c"),
        ("saturating_add_i32", "rt_math.c"),
        ("saturating_sub_i32", "rt_math.c"),
        ("wrapping_add_i32", "rt_math.c"),
        ("vec_i32_capacity", "rt_vec.c"),
        ("vec_i32_fill", "rt_vec.c"),
        ("vec_i32_reserve", "rt_vec.c"),
        ("vec_i32_swap_remove", "rt_vec.c"),
        ("format_i64_bin", "rt_strings.c"),
        ("format_quote", "rt_strings.c"),
        ("atomic_xor_i32", "rt_sync.c"),
        ("str_escape_json", "rt_strings.c"),
        ("str_split_after", "rt_strings.c"),
        ("str_truncate", "rt_strings.c"),
        ("rem_euclid_i32", "rt_math.c"),
        ("rotate_left_i32", "rt_math.c"),
        ("rotate_right_i32", "rt_math.c"),
        ("trailing_zeros_i32", "rt_math.c"),
        ("vec_i32_truncate", "rt_vec.c"),
        ("atomic_and_i32", "rt_sync.c"),
        ("atomic_or_i32", "rt_sync.c"),
        ("file_is_symlink", "rt_fs.c"),
        ("file_mtime", "rt_fs.c"),
        ("path_is_file", "rt_fs.c"),
        ("rename_file", "rt_fs.c"),
    ])
}
...
pub fn c_symbol_for(nyra_fn: &str) -> String {
    const ALIASES: &[(&str, &str)] = &[
        ...
        ("compare", "str_compare"),
        ("equal_fold", "str_equal_fold"),
        ("index_byte", "str_index_byte"),
        ("last_index_byte", "str_last_index_byte"),
        ("after_sep", "str_after_sep"),
        ("contains", "str_contains"),
        ("ends_with", "str_ends_with"),
        ("pop", "str_pop"),
        ("push_char", "str_push_char"),
        ("replace", "str_replace"),
        ("replacen", "str_replacen"),
        ("starts_with", "str_starts_with"),
        ("strip_ansi", "str_strip_ansi"),
        ("trim", "str_trim"),
        ("before_sep", "str_before_sep"),
        ("collapse_ws", "str_collapse_ws"),
        ("is_ascii", "str_is_ascii"),
        ("common_prefix_len", "str_common_prefix_len"),
        ("is_alnum", "str_is_alnum"),
        ("is_alpha", "str_is_alpha"),
        ("is_digit", "str_is_digit"),
        ("pad_center", "str_pad_center"),
        ("reverse", "str_reverse"),
        ("escape_json", "str_escape_json"),
        ("split_after", "str_split_after"),
